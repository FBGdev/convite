...
class InviteFlowTest(unittest.TestCase):
    ...
    def test_confirmation_duplicate_without_gift_prompt(self):
        ...
        self.assertIn("Cada pessoa que for consumir bebida alcoólica deve levar a sua.".encode(), first.data)
    ...
    def test_invite_uses_typographic_opening_and_gift_suggestions(self):
        ...
        self.assertEqual(page.count('Cada pessoa que for consumir bebida alcoólica deve levar a sua.'), 2)
    ...
    def test_wife_and_children_are_optional_for_an_individual_or_decline(self):
        ...
        self.assertNotIn("Cada pessoa que for consumir bebida alcoólica deve levar a sua.".encode(), decline.data)
